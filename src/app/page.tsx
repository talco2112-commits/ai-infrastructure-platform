...
const T = {
  ...
  he: {
    ...
    aiQA: [
      ...
      { q: "אילו פעילויות נמצאות בנתיב הקריטי",         a: "העברת תשתיות ← יסודות קידוח ← טפסנות גשר ← יציקת כרכוב" },
    ],
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 h-16 backdrop-blur-md flex items-center px-8"
        ...
        <div className="max-w-7xl mx-auto w-full flex items-center">
          <Link href="/" className="flex items-center me-12">
            <img src="/לוגו חום בלי רקע.png" alt="InfrAI" style={{ height: 72, objectFit: "contain" }} />
          </Link>
