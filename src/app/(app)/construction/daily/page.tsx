...
const tasks: {
  ...
  { id:"DT-003", task:"Formwork stripping – Bridge deck segment 4A",           taskHe:"פירוק טפסנות – מקטע גשר 4A",                       zone:"B", crew:"Crew C – Dror",      priority:"HIGH",      start:"07:00", end:"13:00", status:"COMPLETE"    },
  ...
  { id:"DT-008", task:"Pre-pour survey check – Pier P8 formwork dimensions",  taskHe:"בדיקת מדידה לפני יציקה – מימדי טפסנות כן P8",      zone:"B", crew:"Surveyor – Shapira", priority:"HIGH",      start:"09:00", end:"11:00", status:"COMPLETE"    },
