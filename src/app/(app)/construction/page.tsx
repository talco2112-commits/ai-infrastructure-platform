...
function DailyTasks({ isHe }: { isHe: boolean }) {
  const kpis = isHe
  ...
  const tasks: { id:string;task:string;taskHe:string;zone:string;crew:string;priority:Pr;start:string;end:string;status:S }[] = [
  ...
  return (
    <>
      ...
      <AIBanner label={isHe?"תובנת AI לתכנית עבודה":"AI Work Plan Insight"} text={ai} />
      <Card>
...
function WeeklyPlan({ isHe }: { isHe: boolean }) {
  const kpis = isHe
  ...
  const activities: {id:string;activity:string;actHe:string;zone:string;week:string;duration:string;status:S}[] = [
  ...
  return (
    <>
      <KPIRow items={kpis} colors={[P.text1, P.good, "#1D4ED8", P.danger]} />
      <AIBanner label={isHe?"תובנת AI לתחזית":"AI Lookahead Insight"} text={ai} />
      <Card>
        <table className="w-full text-[12px]"><THead cols={cols} /><tbody>
...
function MonthlyPlan({ isHe }: { isHe: boolean }) {
  const kpis = isHe
  ...
  const milestones: {ms:string;msHe:string;date:string;owner:string;status:MS}[] = [
  ...
  return (
    <>
      ...
      <AIBanner label={isHe?"תחזית AI חודשית":"AI Monthly Outlook"} text={ai} />
      <Card>
        <table className="w-full text-[12px]"><THead cols={cols} /><tbody>
...
function SpecialOps({ isHe }: { isHe: boolean }) {
  const kpis = isHe
  ...
  const ops: {id:string;type:string;typeHe:string;desc:string;descHe:string;zone:string;datetime:string;permit:string;status:OS}[] = [
  ...
  return (
    <>
      ...
      <AIBanner label={isHe?"התראת AI לפעולות":"AI Operations Alert"} text={ai} danger />
      <Card>
        <table className="w-full text-[12px]"><THead cols={cols} /><tbody>
...
function Procurement({ isHe }: { isHe: boolean }) {
  const kpis = isHe
  ...
  const pos: {po:string;material:string;matHe:string;supplier:string;qty:string;unit:string;value:string;delivery:string;status:PS}[] = [
  ...
  return (
    <>
      ...
      <AIBanner label={isHe?"התראת רכש AI":"AI Procurement Alert"} text={ai} danger />
      <Card>
        <table className="w-full text-[12px]"><THead cols={cols} /><tbody>
...
function Inventory({ isHe }: { isHe: boolean }) {
  const kpis = isHe
  ...
  const items: {item:string;itemHe:string;cat:string;onHand:number;minStock:number;dailyUsage:number;unit:string;status:IS}[] = [
  ...
  return (
    <>
      ...
      <AIBanner label={isHe?"תובנת AI למלאי":"AI Inventory Insight"} text={ai} />
      <Card>
        <table className="w-full text-[12px]"><THead cols={cols} /><tbody>
...
function SiteDiary({ isHe }: { isHe: boolean }) {
  const ai = isHe
  ...
  const work: {zone:string;activity:string;actHe:string;crew:string;qty:string;note:string;noteHe:string}[] = [
  ...
  const issues: {type:string;desc:string;descHe:string;reporter:string}[] = [
  ...
  return (
    <>
      <div className="grid grid-cols-4 gap-3 mb-4">
        {[{label:isHe?"מזג אוויר":"Weather",val:"☀ 31°C"},{label:isHe?"עובדים":"Workers on Site",val:"312"},{label:isHe?"מבקרים":"Visitors",val:"4"},{label:isHe?"שעות עבודה":"Manhours",val:"1,842"}].map((k,i)=>(
      ...
      <AIBanner label={isHe?"סיכום יומן AI":"AI Diary Summary"} text={ai} />
...
function Equipment({ isHe }: { isHe: boolean }) {
  const kpis = isHe
  ...
  const equip: {id:string;desc:string;descHe:string;type:string;zone:string;hours:string;util:number;status:ES;next:string}[] = [
  ...
  return (
    <>
      ...
      <AIBanner label={isHe?"תובנת AI לצי ציוד":"AI Fleet Insight"} text={ai} />
      <Card>
        <table className="w-full text-[12px]"><THead cols={cols}/><tbody>
...
function Subcontractors({ isHe }: { isHe: boolean }) {
  const kpis = isHe
  ...
  const subs: {company:string;companyHe:string;trade:string;tradeHe:string;workers:number;contract:string;perf:number;schedule:"ahead"|"on-track"|"behind";ncrs:number;status:SS2}[] = [
  ...
  return (
    <>
      ...
      <AIBanner label={isHe?"תובנת AI לקבלני משנה":"AI Subcontractor Insight"} text={ai} />
      <Card>
        <table className="w-full text-[12px]"><THead cols={cols}/><tbody>
...
const TAB_CONTENT: Record<TabId, React.FC<{ isHe: boolean }>> = {
