...
const TRANSLATIONS = {
  ...
  he: {
    ...
    ai: "מלאי ברזל 20 מ\"מ נמוך מנקודת ההזמנה מחדש ב-6 ימים — בצריכה הנוכחית (12 טון/יום) המלאי יגיע לאפס ב-5 יולי. מלאי מלט יהיה קריטי ב-4 יולי. לוחות קינוף במלאי עודף (167% מהצורך המתוכנן) — שקול החזרת עודפים לספק.",
...
const inventory: {
  ...
  { item:"Formwork H20 Beams",       itemHe:"קורות קינוף H20",       cat:"Formwork",   catHe:"קינוף",        onHand:1680,  minStock:400,   dailyUsage:20,   unit:"lm",  location:"Yard F-01", locationHe:"מחסן F-01", status:"OVERSTOCK" },
  { item:"Formwork Panels (Doka)",   itemHe:"לוחות קינוף (דוקה)",    cat:"Formwork",   catHe:"קינוף",        onHand:840,   minStock:200,   dailyUsage:0,    unit:"m²",  location:"Yard F-01", locationHe:"מחסן F-01", status:"OVERSTOCK" },
