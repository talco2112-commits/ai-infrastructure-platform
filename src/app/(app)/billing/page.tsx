...
const AI_LINE_ITEMS: AILineItem[] = [
  ...
  { activity:"Formwork – Bridge P8 piers",                activityHe:"טפסנות – כני גשר P8",               zone:"B", qty:840,  unit:"m²",   rate:165    },
